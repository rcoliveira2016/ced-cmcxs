                          ...
                          <div class="col-lg-12 off-margin-left" style="margin-top:5px">
                            ...
                            <div class="col-lg-3 off-margin-left">
                                <label class="checkbox-inline off-margin-lef">
                                  <input id="optionsRadiosInline1" name="interno" value="1" type="checkbox" <?php echo ((isset($u) and !empty($u) and $u->interno==1)? "checked": ""); ?>>(Mostrar esta solicitação no site da câmara)
                                </label>
                            </div>
                          </div>
